...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('videos')->group(function () {
        ...
        Route::get('{user_video}', [VideoController::class, 'show'])->middleware('auth:sanctum');
    ...
    Route::prefix('parties')->group(function () {
        ...
        Route::post('{user_party}/users', [PartyController::class, 'addUser'])->middleware('auth:sanctum');
